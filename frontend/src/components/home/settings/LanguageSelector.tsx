...
export const LanguageSelector = () => {
	...
	return (
		<div className="w-40">
			...
			<span className="text-md">{selected.name}</span>
			...
			{tabOpen && (
				<ul className="px-4 flex flex-col bg-transcendence-black text-transcendence-white text-sm gap-1 rounded-b-lg -mt-2 py-3 absolute z-10 w-40">

...
export const Welcome = () => {
	...
	if (location.pathname === "/login")
		subtitle = (<h1 className="text-transcendence-white font-transcendence-two mt-5 text-right tracking-wider w-60 landscape:w-44 lg:landscape:w-60 landscape:mt-3 lg:landscape:mt-5 landscape:text-sm lg:landscape:text-lg">LOGIN</h1>);
	else if (location.pathname === "/signup")
		subtitle = (<h1 className="text-transcendence-white font-transcendence-two mt-5 text-right tracking-wider w-60 landscape:w-44 lg:landscape:w-60 landscape:mt-3 lg:landscape:mt-5 landscape:text-sm lg:landscape:text-lg">SIGN UP</h1>);
	return (
			...
			<Routes>
				<Route path="/" element={
					<div className="flex flex-col gap-4 md:gap-6 justify-center items-center text-xl font-transcendence-two text-center landscape:text-sm lg:landscape:text-xl">
						<img src={GoogleSignIn} alt="google sign in" className="w-45 hover:brightness-150 landscape:w-35 lg:landscape:w-45"/>

	...
	return (
		...
		grid grid-cols-1 grid-rows-[35%_auto]">
			<div className="flex flex-col items-center justify-end pb-[3vh]">
				<h1 className="text-transcendence-white font-transcendence-one font-extrabold text-7xl tracking-[0.8rem] text-center landscape:text-5xl lg:landscape:text-7xl">{t("welcome.title")}</h1>

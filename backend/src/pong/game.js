...
const { WIDTH, HEIGHT, BALL_SIZE, PADDLE_LEN, PADDLE_WIDTH } = require('./constants');
...
class Game {
    ...
    moveBall()
    {
        ...
        if (this.ball.x >= this.players[0].x && this.ball.x <= this.players[0].x + PADDLE_WIDTH && this.ball.y >= this.players[0].y && this.ball.y <= this.players[0].y + PADDLE_LEN)
        {
        ...
        if (this.ball.x + BALL_SIZE >= this.players[1].x && this.ball.x <= this.players[1].x + PADDLE_WIDTH && this.ball.y + BALL_SIZE >= this.players[1].y && this.ball.y <= this.players[1].y + PADDLE_LEN)
        {
